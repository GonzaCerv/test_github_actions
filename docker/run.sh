...
function show_help() {
    ...
    Options:\n
    \t-i --image_name\t\t Name of the image to be run (default cpp_course).\n
    \t-c --container_name\t Name of the container (default cpp_course_container).\n
    Examples:\n
    \trun.sh\n
...
IMAGE_NAME=${IMAGE_NAME:-cpp_course}
CONTAINER_NAME=${CONTAINER_NAME:-cpp_course_container}
